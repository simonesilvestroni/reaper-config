--[[
 ...
 Provides:
  ...
  Data/x86/variator_mutations.dll
  Data/x86/variator_gui.dll
  Data/x64/variator_mutations.dll
  Data/x64/variator_gui.dll
...
dofile(script_path..[[Data]]..separator..bin..separator..[[variator_gui.dll]])